...
nebo alternativní názvy, se kterými je nutné si poradit. Importovaný soubor může velikostně nabývat až několik desítek MB a jeho zpracování může trvat delší
...
Druhým krokem celkového procesu importu je výběr kampaní, sestav a klíčových slov, které se mají uložit do systému, jelikož nemusí být
opravodým úmyslem všechny kampaně opravdu ukládat. Naopak v případné shodě importovaných a uložených kampaní je vhodné uživatele o této skutečnosti
